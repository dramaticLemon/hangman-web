...
public class WordManagementController {
    ...
    /**
    * Uploads a file containing words for the Hangman game in a specific language.
    *
    * <p>Processing steps:</p>
    * <ol>
    *   <li>Validate the uploaded file (returns HTTP 400 Bad Request if the file is empty).</li>
    *   <li>Read the file content and load words into the specified category using {@link WordLoaderService}.</li>
    *   <li>Prepare a JSON response with:
    *       <ul>
    *         <li><b>language</b> – target language code</li>
    *         <li><b>loaded</b> – number of words successfully loaded</li>
    *         <li><b>skipped</b> – number of words skipped (duplicates, invalid, or already existing)</li>
    *         <li><b>errors</b> – list of errors encountered during processing</li>
    *         <li><b>success</b> – {@code true} if no errors occurred, otherwise {@code false}</li>
    *       </ul>
    *   </li>
    *   <li>Return HTTP 200 OK if processing succeeds.</li>
    *   <li>Return HTTP 500 Internal Server Error with an error message if an unexpected error occurs.</li>
    * </ol>
    *
    * @param language the ISO code of the language for which words are uploaded
    * @param file the uploaded file containing words (one per line, UTF-8 encoded)
    * @param category the category to assign the uploaded words (default is {@code "general"})
    * @return a {@link ResponseEntity} with the upload result or an error response
    */
    ...
    public ResponseEntity<Map<String, Object>> uploadWordsForLanguage(
        ...
        try {
            ...
            WordLoaderService.WordLoadResult result = wordManagementService.loadWordsFromStream(
                    file.getInputStream(), language, category);
     ...
     * Steps performed:
     * 1. Uses {@link WordManagementService#addWord(String, String, String)} to add the word to the specified category.
     ...
     * @param language a word language
    ...
    public ResponseEntity<Map<String, Object>> addWordForLanguage(
        ...
        try {
            ...
            boolean success = wordManagementService.addWord(word, language, category);
     ...
     * Steps performed:
     * 1. Uses {@link WordManagementService#removeWord(String,String)} to remove the specified word.
     ...
     * @param language default lang is `en`
     * @return a {@link ResponseEntity} containing the result of the operation
     */
    @DeleteMapping("/{word}")
    public ResponseEntity<Map<String, Object>> removeWord(
        ...
        try {
            boolean success = wordManagementService.removeWord(word, language);
     ...
     * Steps performed:
     * 1. Uses {@link WordManagementService#wordExists(String, String)} to check if the word is present.
    ...
    public ResponseEntity<Map<String, Object>> checkWordExists(
            @RequestParam(defaultValue = "en") String language,
            @PathVariable String word
    ) {
        try {
            boolean exists = wordManagementService.wordExists(word, language);
